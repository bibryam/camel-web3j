...
public class Web3jProducerTest extends Web3jTestSupport {
    ...
    public void ethGetUncleCountByBlockNumberTest() throws Exception {
        ...
        Exchange exchange = createExchangeWithBodyAndHeader(null, OPERATION, ETH_GET_UNCLE_COUNT_BY_BLOCK_NUMBER);
        template.send(exchange);
        BigInteger body = exchange.getIn().getBody(BigInteger.class);
        assertTrue(body.equals(BigInteger.ONE));
    }
    ...
    public void ethGetTransactionReceiptTest() throws Exception {
        ...
        Exchange exchange = createExchangeWithBodyAndHeader(null, OPERATION, ETH_GET_TRANSACTION_RECEIPT);
        template.send(exchange);
        Optional<Transaction> body = exchange.getIn().getBody(Optional.class);
        assertTrue(body != null);
    }
    ...
    public void dbPutStringTest() throws Exception {
        ...
        Exchange exchange = createExchangeWithBodyAndHeader(null, OPERATION, DB_PUT_STRING);
        template.send(exchange);
        Boolean body = exchange.getIn().getBody(Boolean.class);
        assertTrue(body);
    }
    ...
    public void dbGetStringTest() throws Exception {
        ...
        Exchange exchange = createExchangeWithBodyAndHeader(null, OPERATION, DB_GET_STRING);
        template.send(exchange);
        String body = exchange.getIn().getBody(String.class);
        assertTrue(body.equals("test"));
    }
    ...
    public void dbPutHexTest() throws Exception {
        ...
        Exchange exchange = createExchangeWithBodyAndHeader(null, OPERATION, DB_PUT_HEX);
        template.send(exchange);
        Boolean body = exchange.getIn().getBody(Boolean.class);
        assertTrue(body);
    }
    ...
    public void dbGetHexTest() throws Exception {
        ...
        Exchange exchange = createExchangeWithBodyAndHeader(null, OPERATION, DB_GET_HEX);
        template.send(exchange);
        String body = exchange.getIn().getBody(String.class);
        assertTrue(body.equals("test"));
    }
